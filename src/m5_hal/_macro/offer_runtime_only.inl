...
// hal/v2/runtime/runtime.hpp: masks every non-runtime capability flag
...
// so the runtime kind must be resolved before hal/v2/bus/bus.hpp —
// long before M5HAL_v2.hpp's main scan at the end of the umbrella
