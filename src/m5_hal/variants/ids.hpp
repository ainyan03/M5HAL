...
//   - Values released in a 1.x publication are FROZEN forever (no
...
#define M5HAL_V2_VARIANT_ID_NONE 0

// --- framework variants (1-49) ---
#define M5HAL_V2_VARIANT_ID_FRAMEWORK_ARDUINO  1
#define M5HAL_V2_VARIANT_ID_FRAMEWORK_ESPIDF   2
#define M5HAL_V2_VARIANT_ID_FRAMEWORK_POSIX    3
#define M5HAL_V2_VARIANT_ID_FRAMEWORK_SOFTWARE 4
#define M5HAL_V2_VARIANT_ID_FRAMEWORK_STUB     5
#define M5HAL_V2_VARIANT_ID_FRAMEWORK_FREERTOS 6
#define M5HAL_V2_VARIANT_ID_FRAMEWORK_REMOTE   7

// --- platform variants: host OS (50-99); detection-only so far ---
#define M5HAL_V2_VARIANT_ID_PLATFORM_WINDOWS 50
#define M5HAL_V2_VARIANT_ID_PLATFORM_MACOS   51
#define M5HAL_V2_VARIANT_ID_PLATFORM_LINUX   52
...
#define M5HAL_V2_VARIANT_ID_PLATFORM_AVR       100
#define M5HAL_V2_VARIANT_ID_PLATFORM_ESP8266   101
#define M5HAL_V2_VARIANT_ID_PLATFORM_ESP32     102
#define M5HAL_V2_VARIANT_ID_PLATFORM_RP2040    103
#define M5HAL_V2_VARIANT_ID_PLATFORM_SAMD21    104
#define M5HAL_V2_VARIANT_ID_PLATFORM_SAMD51    105
#define M5HAL_V2_VARIANT_ID_PLATFORM_SPRESENSE 106
#define M5HAL_V2_VARIANT_ID_PLATFORM_STM32     107
...
// fails to compile (unknown M5HAL_V2_VARIANT_ID_<NAME>), and the
...
#define M5HAL_V2_VARIANT_ID_LIST_(X) \
    X(NONE)                          \
    X(FRAMEWORK_ARDUINO)             \
    X(FRAMEWORK_ESPIDF)              \
    X(FRAMEWORK_POSIX)               \
...
/*!
  @brief The variant identity registry as a typed enum (u16 = the wire
         width; values are the M5HAL_V2_VARIANT_ID_* macros).

  For runtime / typed use; the PP macros remain the #if-capable face of
  the same registry.
 */
enum class variant_id_t : uint16_t {
#define M5HAL_V2_VARIANT_ID_ENUM_ENTRY_(NAME) NAME = M5HAL_V2_VARIANT_ID_##NAME,
    M5HAL_V2_VARIANT_ID_LIST_(M5HAL_V2_VARIANT_ID_ENUM_ENTRY_)
#undef M5HAL_V2_VARIANT_ID_ENUM_ENTRY_
};
...
{
    switch (id) {
#define M5HAL_V2_VARIANT_ID_NAME_CASE_(NAME) \
    case variant_id_t::NAME:                 \
        return #NAME;
        M5HAL_V2_VARIANT_ID_LIST_(M5HAL_V2_VARIANT_ID_NAME_CASE_)
#undef M5HAL_V2_VARIANT_ID_NAME_CASE_
    }
    return "UNKNOWN";
}
...
#define M5HAL_V2_VARIANT_ID_VALUE_(NAME) M5HAL_V2_VARIANT_ID_##NAME,
    M5HAL_V2_VARIANT_ID_LIST_(M5HAL_V2_VARIANT_ID_VALUE_)
#undef M5HAL_V2_VARIANT_ID_VALUE_
};
