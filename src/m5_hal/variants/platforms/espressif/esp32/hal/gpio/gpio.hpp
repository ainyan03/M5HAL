...
class Port : public ::m5::hal::v2::gpio::IPort {
public:
...
protected:
    ...
    {
        return _regs->readAll();
    }
    void _writePortMasked(uint32_t set_mask, uint32_t clear_mask) override
    {
        if (clear_mask) {
            _regs->writeLow(clear_mask);
        }
        if (set_mask) {
            _regs->writeHigh(set_mask);
        }
    }
    ::m5::hal::v2::types::gpio_local_pin_t _toLocalPin(uint32_t encoded_num) const override
    {
        return static_cast<::m5::hal::v2::types::gpio_local_pin_t>(__builtin_ctz(encoded_num)) + (_port_index << 5);
    }
    uint32_t _fromLocalPin(::m5::hal::v2::types::gpio_local_pin_t pin_index) const override
    {
        M5HAL_ASSERT(pin_index < static_cast<::m5::hal::v2::types::gpio_local_pin_t>(kWidth), "pin_index out of range");
...
class GPIO : public ::m5::hal::v2::gpio::IGPIO {
public:
    ::m5::hal::v2::gpio::IPort* portForPin(::m5::hal::v2::types::gpio_local_pin_t pin_index) const override
    {
        M5HAL_ASSERT(pin_index < static_cast<::m5::hal::v2::types::gpio_local_pin_t>(Port::kWidth),
...
inline const ::m5::hal::v2::gpio::IGPIO* getMCUGPIO()
{
...
// bootstrap source.
inline const ::m5::hal::v2::gpio::IGPIO* getGPIO()
{
    return getMCUGPIO();
}
...
using Port_esp32 = ::m5::variants::platforms::espressif::esp32::hal::v2::gpio::Port;
using GPIO_esp32 = ::m5::variants::platforms::espressif::esp32::hal::v2::gpio::GPIO;
inline const IGPIO* getMCUGPIO_esp32(void)
{
    return ::m5::variants::platforms::espressif::esp32::hal::v2::gpio::getMCUGPIO();
}
inline const IGPIO* getGPIO_esp32(void)
{
    return ::m5::variants::platforms::espressif::esp32::hal::v2::gpio::getGPIO();
}
}  // namespace m5::hal::v2::gpio
