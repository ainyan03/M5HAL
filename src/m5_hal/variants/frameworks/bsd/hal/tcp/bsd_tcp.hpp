...
public:
     ...
     */
    ::m5::hal::v2::error::error_t attach(int fd, bool take_ownership = true);
    ...
    // StreamReader
    ::m5::hal::v2::result_t<size_t> read(data::DataSpan dst) override;
...
public:
    ...
    ::m5::hal::v2::error::error_t listen(uint16_t port, const char* bind_addr = nullptr, int backlog = 1);
