...
// are the shared BSD-socket variant (bsd/hal/tcp/bsd_tcp.hpp — rationale,
...
#include "../../../bsd/hal/tcp/bsd_tcp.hpp"

namespace m5::variants::frameworks::posix::hal::v2::tcp {
...
/*!
  ...
  `::m5::hal::v2::detail::BsdTcpStream` plus the client `connect`.
 */
class TcpStream : public ::m5::hal::v2::detail::BsdTcpStream {
public:
    /*!
     ...
     */
    ::m5::hal::v2::error::error_t connect(const char* host, uint16_t port, uint32_t timeout_ms = 3000);
};

using TcpListener = ::m5::hal::v2::detail::BsdTcpListener;
