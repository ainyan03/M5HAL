...
#include "../../../bsd/hal/tcp/bsd_tcp.inl"
...
::m5::hal::v2::error::error_t TcpStream::connect(const char* host, uint16_t port, uint32_t timeout_ms)
{
    using ::m5::hal::v2::detail::monotonicMs;
    using ::m5::hal::v2::detail::waitFd;
