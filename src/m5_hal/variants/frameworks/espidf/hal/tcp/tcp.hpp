...
// bodies are the shared BSD-socket variant (bsd/hal/tcp/bsd_tcp.hpp —
...
namespace m5::variants::frameworks::espidf::hal::v2::tcp {

using namespace ::m5::hal::v2;

using TcpStream   = ::m5::hal::v2::detail::BsdTcpStream;
