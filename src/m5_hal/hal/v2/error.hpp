...
/*!
  @namespace m5::hal::v2::error
  @brief Error codes returned by v2 HAL APIs via `result_t<T>`.
 */
namespace m5::hal::v2::error {

/*!
  @brief Error codes returned by v2 HAL APIs.
  ...
  format (spec/design/bytecode.md, `ReportError` / `ReportComplete`)
...
/*!
  @brief Standard return type of v2 HAL APIs: a value of `T` or an
         `error::error_t`.
