...
public:
    ...
    void writeLow() const;
    bool read() const;
    void setMode(::m5::hal::v2::types::gpio_mode_t mode) const;

    /*! @brief Return the local pin index inside the owning `IPort`. */
    ::m5::hal::v2::types::gpio_local_pin_t getLocalPin() const;
...
class IPort {
public:
    void write(::m5::hal::v2::types::gpio_local_pin_t pin_index, bool v)
    {
        _writePinEncoded(_fromLocalPin(pin_index), v);
    }
    void writeHigh(::m5::hal::v2::types::gpio_local_pin_t pin_index)
    {
        _writePinEncodedHigh(_fromLocalPin(pin_index));
    }
    void writeLow(::m5::hal::v2::types::gpio_local_pin_t pin_index)
    {
        _writePinEncodedLow(_fromLocalPin(pin_index));
    }
    bool read(::m5::hal::v2::types::gpio_local_pin_t pin_index)
    {
        return _readPinEncoded(_fromLocalPin(pin_index));
    }
    void setMode(::m5::hal::v2::types::gpio_local_pin_t pin_index, ::m5::hal::v2::types::gpio_mode_t mode)
    {
     ...
     */
    Pin getPin(::m5::hal::v2::types::gpio_local_pin_t pin_index)
    {
    ...
    void writePort(uint32_t set_mask, uint32_t clear_mask)
    {
        _writePortMasked(set_mask, clear_mask);
    }
...
protected:
    ...
    virtual void _setPinModeEncoded(uint32_t encoded_num, ::m5::hal::v2::types::gpio_mode_t mode) = 0;
    ...
    virtual uint32_t _readPortAll()
    {
        return 0;
    }
    virtual void _writePortMasked(uint32_t set_mask, uint32_t clear_mask)
    {
        (void)set_mask;
        (void)clear_mask;
    }
    ...
    virtual ::m5::hal::v2::types::gpio_local_pin_t _toLocalPin(uint32_t encoded_num) const = 0;
    virtual uint32_t _fromLocalPin(::m5::hal::v2::types::gpio_local_pin_t pin_index) const = 0;
...
inline void Pin::setMode(::m5::hal::v2::types::gpio_mode_t mode) const
{
    M5HAL_ASSERT(_owner != nullptr, "Pin is invalid");
    _owner->_setPinModeEncoded(_encoded_num, mode);
}
inline ::m5::hal::v2::types::gpio_local_pin_t Pin::getLocalPin() const
{
    M5HAL_ASSERT(_owner != nullptr, "Pin is invalid");
