...
#ifndef M5_HAL_HAL_V2_MEMORY_ALLOCATOR_INL_
#define M5_HAL_HAL_V2_MEMORY_ALLOCATOR_INL_
...
M5HAL_INLINE_V2 namespace v2
{
    ...
    void Allocator::deallocate(void* ptr)
    {
        if (_temp_pool.deallocate(ptr)) {
            _temp_release_count.fetch_add(1, std::memory_order_relaxed);
            return;
        }
    ...
    size_t Allocator::tempReleaseCount() const
    {
...
#endif  // M5_HAL_HAL_V2_MEMORY_ALLOCATOR_INL_
