...
// the v0 / v2 coexistence strategy.
//
// New code should `#include <M5HAL_v0.hpp>` or `<M5HAL_v2.hpp>`
// directly to spell its intent. When the default switches to v2 in
// the future, only the include below changes — code that already
// spells the explicit header is unaffected.
//
// See README §v0 / v2 coexistence and
// spec/design/v0_v2_coexistence.md for the full picture.
// =============================================================================
